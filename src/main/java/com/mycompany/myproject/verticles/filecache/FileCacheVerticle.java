...
public class FileCacheVerticle extends Verticle {
	...
	/**
	 * static instance of fileCacheImpl
	 */
	...
	public void start() {
		...
		final FileCacheImpl FILE_CACHE = getFileCacheInstance(this.getVertx());
	...
	/**
	 * Maintain single instance of FileCacheImpl
	 */
	public synchronized static FileCacheImpl getFileCacheInstance(Vertx vertx) {
		if (null == fileCache) {
			fileCache = new FileCacheImpl(vertx);
		}
		return fileCache;
	}
